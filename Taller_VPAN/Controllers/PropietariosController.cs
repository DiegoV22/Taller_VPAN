...
namespace Taller_VPAN.Controllers
{
    public class PropietariosController : Controller
    {
        ...
        public PropietariosController(Taller_VPANContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Cedula,FechaNacimiento,EsEcuatoriano,IdA")] Propietario propietario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Cedula,FechaNacimiento,EsEcuatoriano,IdA")] Propietario propietario)
        {
