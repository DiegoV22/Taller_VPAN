...
namespace Taller_VPAN.Controllers
{
    public class MotorsController : Controller
    {
        ...
        public MotorsController(Taller_VPANContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdMotor,TipoMotor,CaballosFuerza,AnioFabricacion")] Motor motor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMotor,TipoMotor,CaballosFuerza,AnioFabricacion")] Motor motor)
        {
            if (id != motor.IdMotor)
            {
                return NotFound();
